...
def main():
    ...
    for model in models:
        ...
        # eval.plot(valid_trend, folder_saving, "valid_trend_1991-2020", trend=True)
        ...
        # eval.plot(model_trend, folder_saving, "model_trend_1991-2020", trend=True)
        # eval.plot(model_trend - valid_trend, folder_saving, "diff_trend_1991-2020", trend=True)
        ...
        # eval.plot(persistence_trend, folder_saving, "persistence_trend_1991-2020", trend=True)
        # eval.plot(model_trend - persistence_trend, folder_saving, "diff_persistence_trend_1991-2020", trend=True)
        #
        #
