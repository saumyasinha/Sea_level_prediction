...
#SBATCH --output=/pl/active/machinelearning/Saumya/ML_for_sea_level/job_outputs/cesm_1yr_attn_2layers_more_hidden_convlstm_no_dilated_monthly_downscaled_future_data_wrmse.%j.out
