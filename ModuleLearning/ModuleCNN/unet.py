...
class UNet(nn.Module):
    ...
    def __init__(self, dim_channels, last_channel_size):
        ...
        #self.dconv_up3 = double_conv(256 + 512, 256,kernel = (3,3), padding = (1,1))
        self.dconv_up2 = double_conv(32 + 64, 32, kernel_1 = (3,3), padding_1 = (1,1),kernel_2 = (3,3), padding_2 = (1,1))#32+64, 32
        self.dconv_up1 = double_conv(32 + 16, 16,kernel_1 = (3,3), padding_1 = (1,1),kernel_2 = (3,4), padding_2 = (2,2)) #90*45 #32+16,16
